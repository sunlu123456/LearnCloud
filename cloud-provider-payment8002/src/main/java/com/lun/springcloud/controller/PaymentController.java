...
public class PaymentController {
    ...
    public CommonResult<Payment> getPaymentById(@PathVariable("id") Long id)
    {
        ...
        if(payment != null)
        {
            return new CommonResult(200,"查询成功,serverPort: "+serverPort/*添加到此处*/,  payment);
        }else{
    ...
    public String paymentZipkin() {
        return "hi ,i'am paymentzipkin serverPort:"+serverPort+" server fall back，welcome to here, O(∩_∩)O哈哈~";
    }
}
